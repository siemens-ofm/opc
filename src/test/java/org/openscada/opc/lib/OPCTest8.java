...
public class OPCTest8
{
    ...
    public static void main ( final String[] args ) throws Throwable
    {
    	...
    	final ServerList serverList = new ServerList ( "localhost", "opc", "opc", "" );

        //final String cls = serverList.getClsIdFromProgId ( "Matrikon.OPC.Simulation.1" );
    	final String cls = serverList.getClsIdFromProgId ( "OPCSample.OpcHdaServer.1" );
        //System.out.println ( "Matrikon OPC Simulation Server: " + cls );
        showDetails ( serverList, cls );

        final Collection<ClassDetails> detailsList = serverList.listServersWithDetails ( new Category[] { Categories.OPCHDAServer10 }, new Category[] {} );
